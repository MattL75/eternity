 ...
 * @param x The base of the exponent expression.
 * @param y The power of the exponent expression.
 * @param rounds Number of rounds to execute on the infinite series.
 */
...
/**
 * Logarithm function, used in various other functions.
 * @param x The contents of the logarithm to evaluate.
 * @param rounds Number of rounds to execute on the infinite series.
 */
